...
{
    /// <summary>
    /// CompanyCollectionResource
    /// </summary>
    [DataContract]
    public partial class CompanyCollectionResource :  IEquatable<CompanyCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyCollectionResource" /> class.
        /// </summary>
        /// <param name="Companies">Companies.</param>
        public CompanyCollectionResource(List<CompanyResource> Companies = default(List<CompanyResource>))
        {
        ...
        public List<CompanyResource> Companies { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyCollectionResource {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompanyCollectionResource);
        }

        /// <summary>
        /// Returns true if CompanyCollectionResource instances are equal
        /// </summary>
        /// <param name="other">Instance of CompanyCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyCollectionResource other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
