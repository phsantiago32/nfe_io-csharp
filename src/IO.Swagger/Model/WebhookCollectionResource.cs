...
namespace IO.Swagger.Model
{
    ...
    public partial class WebhookCollectionResource :  IEquatable<WebhookCollectionResource>, IValidatableObject
    {
        ...
        public WebhookCollectionResource(List<WebhookResource> Hooks = default(List<WebhookResource>))
        {
            this.Hooks = Hooks;
        }
        ...
        public List<WebhookResource> Hooks { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WebhookCollectionResource);
        }

        /// <summary>
        /// Returns true if WebhookCollectionResource instances are equal
        /// </summary>
        /// <param name="other">Instance of WebhookCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookCollectionResource other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.Hooks != null &&
                    this.Hooks.SequenceEqual(other.Hooks)
                );
        }
