...
{
    /// <summary>
    /// ServiceInvoiceCollectionResource
    /// </summary>
    [DataContract]
    public partial class ServiceInvoiceCollectionResource :  IEquatable<ServiceInvoiceCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceInvoiceCollectionResource" /> class.
        /// </summary>
        /// <param name="TotalResults">TotalResults.</param>
        /// <param name="TotalPages">TotalPages.</param>
        /// <param name="Page">Page.</param>
        /// <param name="ServiceInvoices">ServiceInvoices.</param>
        public ServiceInvoiceCollectionResource(long? TotalResults = default(long?), int? TotalPages = default(int?), int? Page = default(int?), List<ServiceInvoiceResource> ServiceInvoices = default(List<ServiceInvoiceResource>))
        {
        ...
        /// <summary>
        /// Gets or Sets ServiceInvoices
        /// </summary>
        [DataMember(Name="serviceInvoices", EmitDefaultValue=false)]
        public List<ServiceInvoiceResource> ServiceInvoices { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceInvoiceCollectionResource {\n");
            sb.Append("  TotalResults: ").Append(TotalResults).Append("\n");
            sb.Append("  TotalPages: ").Append(TotalPages).Append("\n");
            sb.Append("  Page: ").Append(Page).Append("\n");
            sb.Append("  ServiceInvoices: ").Append(ServiceInvoices).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ServiceInvoiceCollectionResource);
        }

        /// <summary>
        /// Returns true if ServiceInvoiceCollectionResource instances are equal
        /// </summary>
        /// <param name="other">Instance of ServiceInvoiceCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceInvoiceCollectionResource other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.ServiceInvoices == other.ServiceInvoices ||
                    this.ServiceInvoices != null &&
                    this.ServiceInvoices.SequenceEqual(other.ServiceInvoices)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ServiceInvoices != null)
                    hash = hash * 59 + this.ServiceInvoices.GetHashCode();
                return hash;
            }
        }
